...
export default function WalletEdit(props: { wallet: Wallet }) {
    const { wallet } = props;
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: 'Edit', href: `/wallets/${wallet.id}/edit` },
    ];
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="p-4">
                <div className="mb-4">
                    <h1 className="text-xl font-semibold">Edit Wallet</h1>
                    <p className="text-sm text-muted-foreground">
                        Perbarui data wallet.
                    </p>
                </div>
